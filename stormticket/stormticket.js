// $Id: stormticket.js,v 1.1.4.1 2009/04/13 11:36:05 magnity Exp $
...
/*  stormperson_project_people(_project_select, _person_select_id, _with_all_option, _all_text);*/
...
function stormticket_organization_project_task_tickets(_organization_select, _project_select_id, _person_select_id, _task_select_id, _ticket_select_id, _with_all_option, _all_text) {
  stormproject_organization_projects(_organization_select, _project_select_id, _with_all_option, _all_text);
//   stormperson_organization_people(_organization_select, _person_select_id, _with_all_option, _all_text);
  var project_select = $("#" + _project_select_id).get(0);
...
function stormperson_project_people(_project_select, _person_select_id, _with_all_option, _all_text) {
  ...
  $.ajax({
    type: "GET",
    async: true,
    url: Drupal.settings.storm.organization_people_url + Drupal.encodeURIComponent(project_nid),
    dataType: "string",
    success: function (data) {
      var items = Drupal.parseJson(data);
